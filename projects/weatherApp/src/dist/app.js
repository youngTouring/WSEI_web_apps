...
var App = /** @class */ (function () {
    function App() {
        this.apiKey = "3e698a7061f00f91ccff4b6219d2b140";
        this.storageKey = "weatherItems";
    }
    App.prototype.getItems = function () {
        var items = this._getItemsAsString();
        return items ? JSON.parse(items) : [];
    };
    App.prototype._getItemsAsString = function () {
        return localStorage.getItem(this.storageKey);
    };
    App.prototype.setOrSkip = function (cityIdentifier) {
        var items = this._getItemsAsString();
        var itemAsArray = items ? JSON.parse(items) : [];
    ...
    App.prototype.getCityInfo = function (cityName, cityId) {
        if (cityName === void 0) { cityName = ""; }
        if (cityId === void 0) { cityId = null; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._getWeather(cityName, cityId)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    App.prototype._getWeather = function (cityName, cityId) {
        if (cityName === void 0) { cityName = ""; }
        if (cityId === void 0) { cityId = null; }
